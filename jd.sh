...
export TZ='Asia/Shanghai' 
 ...
 cd /home/kasm-user/Desktop/dslz/T5/jd
...
echo "当前时间：$current_time"
    ...
    if [ "$current_hour" -eq 22 ] && [ "$current_minute" -ge 24 ] && [ "$current_minute" -le 42 ]; then
        ...
        rm -f /home/kasm-user/Desktop/dslz666/jdck.log
    ...
    echo "*******************************************************"
    echo "删除 /Desktop/dslz666/jd.log 的时间是$current_hour:$current_minute"
    echo "删除 /Desktop/dslz666/jd.log 的时间是$current_hour:$current_minute" >> $PWD/jdck_dslz.log
     rm -f  $PWD/jd.log
